...
export default function Cart() {
  ...
  const handleSubmit = (e) => {
    ...
    if (Object.keys(newErrors).length === 0) {
      ...
      axios
        .post(
          `https://clock-shop-backend.onrender.com/checkout/address-save/`,
          { address_data },
          {
            headers: {
  ...
  useEffect(() => {
    ...
    if (accessToken) {
      axios
        .get("https://clock-shop-backend.onrender.com/cart/cartlist/", {
          headers: {
            Authorization: `Bearer ` + localStorage.getItem("access_token"),
            "Content-Type": "application/json",
          },
  ...
  useEffect(() => {
    ...
    if (accessToken) {
      axios
        .get("https://clock-shop-backend.onrender.com/address/address-list/", {
          headers: {
            Authorization: `Bearer ` + localStorage.getItem("access_token"),
            "Content-Type": "application/json",
          },
  ...
  useEffect(() => {
    ...
    if (accessToken) {
      axios
        .get(`https://clock-shop-backend.onrender.com/address/address-detail/`, {
          headers: {
            Authorization: `Bearer ` + localStorage.getItem("access_token"),
            "Content-Type": "application/json",
          },
  ...
  const handleConfirmDelete = () => {
    ...
    axios
      .delete(`https://clock-shop-backend.onrender.com/cart/cartdelete/${id}/`, {
        headers: {
          Authorization: `Bearer ` + localStorage.getItem("access_token"),
          "Content-Type": "application/json",
        },
  ...
  const cartCountIncrement = (id, count, index) => {
    ...
    axios
      .post(`https://clock-shop-backend.onrender.com/cart/cart-count-update/`, incrementBody, {
        headers: {
          Authorization: `Bearer ` + localStorage.getItem("access_token"),
          "Content-Type": "application/json",
        },
  ...
  const cartCountDecrement = (id, count, index) => {
    ...
    axios
      .post(`https://clock-shop-backend.onrender.com/cart/cart-count-update/`, decrementBody, {
        headers: {
          Authorization: `Bearer ` + localStorage.getItem("access_token"),
          "Content-Type": "application/json",
        },
  ...
  const checkoutAllPrdoducts = () => {
    axios
      .get("https://clock-shop-backend.onrender.com/checkout/test-checkout/", {
        headers: {
          Authorization: `Bearer ` + localStorage.getItem("access_token"),
          "Content-Type": "application/json",
        },
  ...
  const CheckoutForm = () => {
    ...
    const handleSubmit = async (event) => {
      ...
      if (result.error) {
        ...
        axios
          .get(`https://clock-shop-backend.onrender.com/checkout/cart-checkout/`, {
            headers: {
              Authorization: `Bearer ` + localStorage.getItem("access_token"),
              "Content-Type": "application/json",
            },
